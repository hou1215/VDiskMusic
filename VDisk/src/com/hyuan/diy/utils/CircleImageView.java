...
public class CircleImageView extends ImageView implements Serializable
{
	...
	private void updateShaderMatrix()
	{
		...
		mShaderMatrix.preRotate(currentRoatate, mBitmapWidth / 2,mBitmapHeight / 2);
	...
	private CdTask01 task = new CdTask01();
	...
	private boolean isReversal = false;// 转动方向
	private boolean start = false;
	Handler handler = new Handler();


	private class CdTask01 extends Thread
	{
