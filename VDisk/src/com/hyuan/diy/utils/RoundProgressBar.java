...
public class RoundProgressBar extends View
{
	...
	protected void onDraw(Canvas canvas)
	{
		...
		paint.setColor(getResources().getColor(R.color.roundColor)); //设置圆环的颜色
		...
		//设置进度是实心还是空心
		paint.setStrokeWidth(roundWidth); //设置圆环的宽度
		paint.setColor(getResources().getColor(R.color.roundProgressColor));  //设置进度的颜色
